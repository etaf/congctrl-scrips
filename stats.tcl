...
Stats instproc showstats { rcd_bytes rcd_avgrtt } {
    ...
    puts [format "conn: %d rbytes: %d rMbps: %f fctMs: %f abytes: %d aMbps: %f sndrttMs %f rcdrttMs %f s_util: %f r_util: %f onperc: %f" $srcid_ $rcd_bytes $rcdtput $fct $numbytes_ $throughput $avgrtt $rcd_avgrtt $util_s $util_r $on_perc]
}
